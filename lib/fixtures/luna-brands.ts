...
const ruleNames: IdentityRuleName[] = ["Logo", "Colour", "Typography", "Iconography", "Imagery", "Tone of Voice"];
...
function rules(states: Record<IdentityRuleName, InheritanceState>, notes: Partial<Record<IdentityRuleName, string>> = {}): IdentityRule[] {
  return ruleNames.map((name) => ({
    ...
    note: notes[name] ?? (states[name] === "Inherited" ? "Uses the shared Luna system." : states[name] === "Overridden" ? "A Brand-specific decision replaces the parent rule." : states[name] === "Unique" ? "Defined specifically for this Brand." : "No rule has been established yet."),
  }));
}
...
export const lunaBrandFixtures: Brand[] = [
  {
    ...
    identityRules: rules({ Logo: "Unique", Colour: "Unique", Typography: "Unique", Iconography: "Unique", Imagery: "Unique", "Tone of Voice": "Unique" }, { Logo: "The primary Luna identity source.", Colour: "Defines the shared Luna palette.", Typography: "Defines the family typography system." }),
  ...
  },
  {
    ...
    identityRules: rules({ Logo: "Not configured", Colour: "Inherited", Typography: "Inherited", Iconography: "Not configured", Imagery: "Unique", "Tone of Voice": "Inherited" }), childBrandIds: [],
  },
  {
    ...
    identityRules: rules({ Logo: "Overridden", Colour: "Overridden", Typography: "Inherited", Iconography: "Inherited", Imagery: "Unique", "Tone of Voice": "Inherited" }), childBrandIds: [],
  },
];
