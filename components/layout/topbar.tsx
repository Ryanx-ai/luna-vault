...
export function Topbar({ onMenuClick }: { onMenuClick: () => void }) {
  ...
  return (
    <header className="sticky top-0 z-30 grid h-14 shrink-0 grid-cols-[minmax(0,1fr)_auto] items-center border-b bg-canvas/95 px-4 backdrop-blur md:grid-cols-[minmax(180px,1fr)_minmax(180px,320px)_minmax(220px,1fr)] md:px-6">
