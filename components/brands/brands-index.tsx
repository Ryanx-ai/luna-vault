  ...
  return (
    <div className="mx-auto w-full max-w-[1180px] px-4 py-7 sm:px-6 sm:py-9 lg:px-8">
      <header className="flex flex-col gap-5 border-b pb-6 sm:flex-row sm:items-end sm:justify-between">
        <div><p className="text-[10px] font-semibold uppercase tracking-[0.14em] text-accent">{selectedVault.name} Vault</p><h1 className="mt-2 text-2xl font-semibold tracking-[-0.025em] sm:text-3xl">Brands</h1><p className="mt-2 max-w-xl text-xs leading-5 text-muted">Navigate the Brand Family and open each Brand’s authoritative Identity System.</p></div>
